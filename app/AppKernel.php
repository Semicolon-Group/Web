...
class AppKernel extends Kernel
{
    public function registerBundles()
    {
        $bundles = [
            ...
            new Member\MemberBundle\MemberMemberBundle(),
            new Member\NewsFeedBundle\MemberNewsFeedBundle(),
            new Member\MatchBundle\MemberMatchBundle(),
            new Member\EventBundle\MemberEventBundle(),
            new Member\ExperienceBundle\MemberExperienceBundle(),
            new Member\RecommandationBundle\MemberRecommandationBundle(),
